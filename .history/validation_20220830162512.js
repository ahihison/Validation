        ...
        formElement.onsubmit = function(e){
           ...
           if(isFormValid){
            if(typeof options.onSubmit === 'function'){
                var enableInputs = formElement.querySelectorALL('[nam]');
                var formValues = Array.form(enableInputs).reduce(function (result,input){
                    return (value[input.name] = input.value) && va
                })
                options.onSubmit({
